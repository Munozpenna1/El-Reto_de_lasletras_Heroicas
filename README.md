...
def ocultar_palabra(lista): # Crea una representación oculta de la palabra
    oculta = "_" * len(palabra)
    return oculta
palabra2 = ocultar_palabra(lista)
# print (palabra2)
def mostrar_palabra(palabra_oculta):    # Muestra la representación actual de la palabra oculta
...
No olvidar las otras definiciones
